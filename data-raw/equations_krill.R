...
refs$Morr1988 <- "Morris DJ, Watkins JL, Ricketts C, Buchholz F, Priddle J (1988) An assessmant of the merits of length and weight measurements of Antarctic krill Euphausia superba. British Antarctic Survey Bulletin 79:27-50"
refs$Hewi2004 <- "Hewitt RP, Watkins J, Naganobu M, Sushin V, Brierley AS, Demer D, Kasatkina S, Takao Y, Goss C, Malyshko A, Brandon M (2004) Biomass of Antarctic krill in the Scotia Sea in January/February 2000 and its use in revising an estimate of precautionary yield. Deep Sea Research Part II: Topical Studies in Oceanography 51:1215-1236. doi:10.1016/j.dsr2.2004.06.011"
...
alleq_krill <- function(id) {
    switch(id,
           "236217J_TL_Goeb2007"=list(taxon_name="Euphausia superba",
                                     ...
                                     return_property="krill total length",
                                     return_units="mm",
           ...
           "236217_WW_Morr1988"=list(taxon_name="Euphausia superba",
                                     ...
                                     inputs=tibble(property="krill total length",units="mm",sample_minimum=22,sample_maximum=48),
