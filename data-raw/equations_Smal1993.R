    ...
    switch(id,
           ...
           "140605_HL_Smal1993"=list(taxon_name="Octopus vulgaris",
                                     ...
                                     reliability=tribble(~type,~value,
                                                         ...
                                                         "R^2",0.87),
                                     reference=refs$Smal1993),
           "140605_mass_Smal1993"=list(taxon_name="Octopus vulgaris",
                                       taxon_aphia_id=140605,
           ...
           "535784_HL_Smal1993"=list(taxon_name="Enteroctopus magnificus",
                                     ...
                                     reliability=tribble(~type,~value,
                                                         ...
                                                         "R^2",0.96),
                                     reference=refs$Smal1993),
           "535784_mass_Smal1993"=list(taxon_name="Enteroctopus magnificus",
                                       taxon_aphia_id=535784,
           ...
           "341910_HL_Smal1993"=list(taxon_name="Bathypolypus valdiviae",
                                     ...
                                     reliability=tribble(~type,~value,
                                                         ...
                                                         "R^2",0.79),
                                     reference=refs$Smal1993),
           "341910_mass_Smal1993"=list(taxon_name="Bathypolypus valdiviae",
                                       taxon_aphia_id=341910,
           ...
           "141694_HL_Smal1993"=list(taxon_name="Tremoctopus violaceus",
                                     taxon_aphia_id=141694,
                                       ...
                                       reliability=tribble(~type,~value,
                                                           ...
                                                           "R^2",0.94),
                                       reference=refs$Smal1993),
           "141694_mass_Smal1993"=list(taxon_name="Tremoctopus violaceus",
                                       taxon_aphia_id=141694,
           ...
           "137676_HL_Smal1993"=list(taxon_name="Argonauta",
                                     ...
                                     reliability=tribble(~type,~value,
                                                         ...
                                                         "R^2",0.95),
                                     reference=refs$Smal1993),
           "137676_mass_Smal1993"=list(taxon_name="Argonauta",
                                       taxon_aphia_id=137676,
